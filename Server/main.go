...
import (
	...
	"go_server/Server/infrastructure"
	global_card_service_server "go_server/Server/infrastructure/grpc_infr/global_card"
	global_deck_service_server "go_server/Server/infrastructure/grpc_infr/global_deck"
	auth_service_server "go_server/Server/infrastructure/grpc_infr/user/auth"
	user_service_server "go_server/Server/infrastructure/grpc_infr/user/user"
	validation_service_server "go_server/Server/infrastructure/grpc_infr/user/validation"
	user_deck_progress_service_server "go_server/Server/infrastructure/grpc_infr/user_deck_progress"
	user_progress_card_service_server "go_server/Server/infrastructure/grpc_infr/user_progress_card"
	"go_server/Server/infrastructure/interceptors"
	repositories2 "go_server/Server/infrastructure/repositories"
	auth_server "go_server/Server/interfaces/grpc_interfaces/auth_service_server"
	global_card_server "go_server/Server/interfaces/grpc_interfaces/global_card_service_server"
	"go_server/Server/interfaces/grpc_interfaces/global_deck_server"
	user_deck_progress_server "go_server/Server/interfaces/grpc_interfaces/user_deck_progress_service_server"
	user_progress_card_server "go_server/Server/interfaces/grpc_interfaces/user_progress_card_service_server"
	"go_server/Server/interfaces/grpc_interfaces/user_server"
	validation_server "go_server/Server/interfaces/grpc_interfaces/validation_service_server"
...
func main() {
	...
	userRepo := repositories2.NewPostgresUserRepository(dbpool)
	globalDeckRepo := repositories2.NewPostgresGlobalDeckRepository(dbpool)
	deckPermissionRepo := repositories2.NewDeckPermissionRepository(dbpool)
	globalCardRepo := repositories2.NewPostgresGlobalCardRepository(dbpool)
	userDeckProgressRepo := repositories2.NewPostgresUserDeckProgressRepository(dbpool)
	userProgressCardRepo := repositories2.NewPostgresUserProgressCardRepository(dbpool)
	emailVerificationRepo := repositories2.NewPostgresEmailVerificationRepository(dbpool)
