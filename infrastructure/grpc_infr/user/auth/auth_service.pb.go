...
func (x *LoginResponse) GetIsPasswordCorrect() bool {
	if x != nil {
		return x.IsPasswordCorrect
	}
	return false
}
...
const file_proto_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x18proto/auth_service.proto\x12\tuser.auth\"J\n" +
	...
	"\auser_iD\x18\x03 \x01(\x05R\x06userID2\x9a\x01\n" +
	"\vAuthService\x12:\n" +
	"\x05Login\x12\x17.user.auth.LoginRequest\x1a\x18.user.auth.LoginResponse\x12O\n" +
	"\fRefreshToken\x12\x1e.user.auth.RefreshTokenRequest\x1a\x1f.user.auth.RefreshTokenResponseB)Z'infrastructure/grpc_infr/user/auth;authb\x06proto3"
...
var file_proto_auth_service_proto_goTypes = []any{
	(*LoginRequest)(nil),         // 0: user.auth.LoginRequest
	(*LoginResponse)(nil),        // 1: user.auth.LoginResponse
...
var file_proto_auth_service_proto_depIdxs = []int32{
	0, // 0: user.auth.AuthService.Login:input_type -> user.auth.LoginRequest
	2, // 1: user.auth.AuthService.RefreshToken:input_type -> user.auth.RefreshTokenRequest
	1, // 2: user.auth.AuthService.Login:output_type -> user.auth.LoginResponse
	3, // 3: user.auth.AuthService.RefreshToken:output_type -> user.auth.RefreshTokenResponse
