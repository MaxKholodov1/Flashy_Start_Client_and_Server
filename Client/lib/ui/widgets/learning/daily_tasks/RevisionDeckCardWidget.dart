...
class RevisionDeckCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        context.read<LearningScreensCubit>().showReviewingCardsScreen(currentUserDeckProgress.deckID);
      },
      child: Container(
